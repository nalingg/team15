...
<div class="container">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <!-- 스카우팅 노트 active: select/profile/mynotes 묶음 -->
                    <li class="nav-item">
    ...
    <!-- 페이지 타이틀 -->
    <h1 class="mb-4 display-6 text-center page-title">
        선수 상세 정보 (<?= htmlspecialchars($player['player_name']) ?>)
    </h1>

    <p class="text-secondary mb-4 text-center">
        선택한 팀(<?= htmlspecialchars($target_team_name) ?>) 선수의 정보를 확인하고 스카우팅 노트를 관리합니다.
    </p>
